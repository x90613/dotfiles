...
for i in special_commands
    execute 'syn match shSpecial "\v(\w|-)@<!'
                \ . i
                \ . '(\w|-)@!" containedin=shFunctionOne,shFunctionTwo,shFunctionThree,shFunctionFour,shFunctionTwo,shIf,shCmdParenRegion,shCommandSub,zshBrackets'
endfor
